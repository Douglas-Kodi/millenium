    ...
    <div class="post">
        ...
        <div class="w3-modal-content w3-card-4 w3-animate-top">
            ...
            <div class="w3-container">
                <p>Deseja mesmo excluir esse post?</p>
            </div>
            <footer class="w3-container w3-teal">
                <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom" @click="removePost()" onclick="document.getElementById('id01').style.display='none'"><i class="fa fa-thumbs-up"></i> &nbsp;Excluir</button>
            </footer>
        </div>
        </div>
        ...
        <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half" v-for="(photo, index) in photos" :key="index">
                <img v-if="post.id == photo.post_id" v-bind:src="'/storage/img/post/'+photo.src" style="width:100%;padding:auto auto;border:1px black solid;" class="w3-margin-bottom" v-bind:alt="photo.src">
            </div>
        </div><br>
